...
namespace MeltDown
{
    public class SlowMonsterController : MonsterController
    {
        ...
        public void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            {
                collision.GetComponent<CharacterController>().SlowDownByTimes(2);
            }
        }
        ...
        public void OnTriggerExit2D(Collider2D collision)
        {
            ...
            {
                collision.GetComponent<CharacterController>().RemoveSlowDown();
            }
        }
    }
}
